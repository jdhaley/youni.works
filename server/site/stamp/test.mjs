export default {
	package$: false,
	use: {
		package$layout: "youni.works/graphic/layout"
	},
	pages: [
		{
			type$: "use.layout.Page",
			title: "Great Britain",
			content: [
				{
					type$: "use.layout.Group",
					content: [
						{
							type$: "use.layout.Group",
							title: "First Issue",
